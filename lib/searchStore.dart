                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(primary: Colors.black26, fixedSize: Size.fromHeight(50)),
                              child: const Text('검색', style: TextStyle(color: Colors.black, fontSize: 15), ),
                            )
                          ],
                        )
                    ),
                          ...
                          mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(storeName[index], style: TextStyle(color: Colors.black, fontSize: 30),),
                              ),
                              Row(
                                ...
                                children: [
                                  Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(storeLocation[index], textAlign: TextAlign.left,),)
                                  ),
                                  Align(
                                      // alignment: Alignment.bottomRight,
                                      child: Container(
                                        padding: const EdgeInsets.fromLTRB(10, 15, 10, 0),
                                        child: Text(storeDistance[index], textAlign: TextAlign.right, style: TextStyle(color: Colors.black, fontSize: 20),),)
                                  )
                                ]
                              )
                            ]
